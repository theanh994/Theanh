                        ...
                        while ($inventory = mysqli_fetch_array($query_inventory_info)) {
                            ...
                            <div class="receipt__info">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="receipt__info--agency">Tên tên chi nhánh: <input class="receipt__info--input" name="agency_name" value="<?php echo $inventory['agency_name'] ?>" type="text" readonly></p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
