                                    ...
                                    if (isset($_SESSION['inventory'])) {
                                        ...
                                        foreach ($_SESSION['inventory'] as $inventory_item) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo number_format($inventory_item['product_price_import']) . '₫' ?></td>
                                                <td class="text-right"><?php echo $inventory_item['agency_name'] ?></td>

                                                <input type="hidden" name="agency_name" value="<?php echo $inventory_item['agency_name']; ?>">
            ...
            <div class="card-body">
                <div class="card-content">
                    <form action="modules/inventory/xuly.php" method="POST">
                        ...
                        <div class="input-item form-group">
                            <label for="agencyid" class="d-block">Chi nhánh</label>
                            <select name="agency_id" id="agencyid" class="form-control select_agency" required>
                                <?php
                                $sql_agency_list = "SELECT * FROM agency ORDER BY agent_id DESC";
                                $query_agency_list = mysqli_query($mysqli, $sql_agency_list);
                                while ($row_agency = mysqli_fetch_array($query_agency_list)) {
                                    ?>
                                    <option value="<?php echo $row_agency['agent_id'] ?>"><?php echo $row_agency['name'] ?></option>
                                    <?php
                                }
                                ?>
                            </select>
