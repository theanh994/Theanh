...
if ($_SESSION['account_type'] == 3) {
    $sql_product_list = "SELECT product.*, MAX(inventory_detail.product_stock) AS product_quantity 
                         FROM product 
                         JOIN inventory_detail ON product.product_id = inventory_detail.product_id 
