            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-content">
                        ...
                        <div id="image-preview-multiple" class="d-flex flex-wrap"></div> <!-- Nơi hiển thị hình ảnh đã chọn -->
                        <style>
                        ...
                        <script>
                            ...
                            multipleUploadButton.onchange = () => {
                                imagePreviewMultiple.innerHTML = ''; // Xóa hình ảnh đã hiển thị trước đó
                                ...
                                fileArray.forEach(file => {
                                    ...
                                    reader.onload = () => {
                                        // Tạo thẻ img và thêm vào khu vực preview
