                            ...
                            <div class="col col-lg-7">
                                ...
                                <div class="checkout__infomation">
                                    ...
                                    ?>
                                        ...
                                        <div class="info__item d-flex">
                                            <label class="info__title" for="">Chi nhanh:</label>
                                            <input type="text" class="info__input flex-1" name="delivery_note" value="<?php echo $account['agency_name'] ?>" readonly></input>
                                        </div>
