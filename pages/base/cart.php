...
<div id="toast_message"></div>
    <div style="margin-left: 200px; margin-top: 50px">
        ...
        <a style="color: #2d2b2b" class="h4" href="index.php?page=product_category">Quay lại cửa hàng</a>
    </div>
<section class="cart pd-section">
    <div class="container">
        ...
        ?>
                    ...
                    ?>
                            <div class="cart__item d-grid" >
                                ...
                                <div class="cart__title">
                                    <h3 style="white-space: nowrap" class="cart__name h4"><?php echo $cart_item['product_name'] ?></h3>
                                </div>
                                <div class="cart__quantity">
                                ...
                                <div style="white-space: nowrap" class="cart__total h4"><?php echo (number_format($cart_item['product_price'] - ($cart_item['product_price'] / 100 * $cart_item['product_sale']))) . ' ₫' ?></div>
                            </div>
                        <?php
            ...
            <div class=" w-100 h-100" style="margin-left: 50px">
                ...
                if (isset($_SESSION['account_email'])) {
                    if ($validate == true) {
                ?>
                        <a  href="index.php?page=checkout" class="btn cart__btn btn__solid text-center" style="background-color: #22B24C; border-radius: 20px;border-color: #22B24C">Tiến hành đặt hàng</a>
                    <?php } else {
                    ?>
                        <button style="background-color: #22B24C; border-radius: 20px;border-color: #22B24C" class="btn cart__btn btn__solid text-center opacity-50" onclick="showErrorMessage();">Tiến hành đặt hàng</button>
                    <?php
                    }
                } else {
                    ?>
                    <a href="index.php?page=login" ><button class="btn cart__btn btn__outline" style="background-color: #f0d200;">Đăng nhập đặt hàng</button></a>
                <?php
                }
                ?>
